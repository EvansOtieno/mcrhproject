		...
		<div class="container-fluid col-md-8"
			...
			<form:form action="${reg}" method="POST" class="form-group"
						...
						<div class="row">
							...
							<div class="col-md-4">
								<form:input required="true" path="child.middlename"
									...
									placeholder="Middlename" pattern="[a-zA-Z]{3,}"
									oninvalid="setCustomValidity('Names must contain alphabets of not less than 3 characters   ')" />
							</div>
							<div class="col-md-4">
								<form:input required="true" path="child.lastname" id="lastname"
									cssClass="w3-input" minlength="3" placeholder="Lastname"
									pattern="[a-zA-Z]{3,}"
									oninvalid="setCustomValidity('Names must contain alphabets of not less than 3 characters   ')" />
				...
				<div class="row">
					...
					<div class="form group col-md-3">
						...
						<form:input path="child.birthtypeother" name="type"
							class="w3-input" placeholder="specify type" />
					</div>
					<div class="form group col-md-3">
						...
						<div class="row">
							<div class="col-md-8">
								<form:input required="true" path="child.pob" id="pob"
									...
									placeholder="Place Of Birth Sub-location or Estate andTown or Health Instituition" />
							</div>
							<div class="col-md-4">
								<form:input required="true" path="child.pobsub" id="pobsub"
									cssClass="w3-input" minlength="3" placeholder="Sub-County" />
							</div>
						</div>
					</div>
				</div>
					...
					<div class="form-group col-md-4">
						<div>
							...
							<form:input required="true" path="mother.idno" id="idno"
								type="text" cssClass="w3-input" minlength="3"
								placeholder="Id Number:if lacking use 0" />
						...
						<div class="row">
							...
							<div class="col-md-4">
								...
								<form:input required="true" path="notificationtoid" id="notid"
									cssClass="w3-input" minlength="3" placeholder="Id NUmber" />

							</div>
							<div class="col-md-4">

								<form:label path="">Date Issued</form:label>
				...
				<form:button type="submit"
					...
					id="sumitregistration">Submit</form:button>
